export const SOUL_MESH_PEERS = ['N01','N02','N03','N04','N05','N06','N07'] as const;
...
export function peerRoutes(peer: SoulMeshPeer): SoulMeshPeerRoute[] { return R4_PEER_ROUTES.filter((route) => route.peer === peer); }
