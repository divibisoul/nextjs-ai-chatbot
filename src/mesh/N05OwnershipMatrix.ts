export type N05Nucleus = 'N01'|'N02'|'N03'|'N04'|'N05'|'N06'|'N07';
...
export const N05_OWNERSHIP: Record<string,OwnershipRule> = {
  ...
  'document.': { owner:'N04', consumers:['N01','N02','N03','N05','N06','N07'], fallback:['N06'] },
  'audio.': { owner:'N03', consumers:['N01','N02','N04','N05','N06','N07'], fallback:['N01'] },
  'speech.': { owner:'N03', consumers:['N01','N02','N04','N05','N06','N07'], fallback:['N01'] },
